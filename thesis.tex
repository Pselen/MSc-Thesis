...
\examineri{Prof. Nilg\"{u}n L\"{u}tfiye Karal{\i}\quad\quad\quad}
\examinerii{Prof. Tunga G\"{u}ng\"{o}r}
...
\input{chapters/preambles/acknowledgements}
\input{chapters/abstract/abstract}
\input{chapters/abstract/abstract_tr}

\tableofcontents
\listoffigures
\listoftables
\input{chapters/preambles/symbols}

\input{chapters/preambles/abbreviations}


\input{chapters/introduction/introduction.tex}
%Start with an introduction...
\input{chapters/biomolecule_representations/biomolecule_representation}
\input{chapters/literaturereview/literature.tex}
%\include{experiments_results}
\input{chapters/background/background}
\input{chapters/datasetpreparation/datasetpreparation.tex}
\input{chapters/graphml/graphml}
